...
export default function BookRide() {
  ...
  const estimatedFare = selectedCab === "mini" ? "₹120–150" : selectedCab === "sedan" ? "₹180–220" : selectedCab === "suv" ? "₹250–300" : "₹350–420";
    ...
    <div className="min-h-screen bg-background pt-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <p className="text-muted-foreground">Fast, safe, and affordable rides at your fingertips</p>
        </motion.div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                <Label className="text-card-foreground mb-2 flex items-center gap-2">
            ...
            <div className="space-y-4">
              <Label className="text-card-foreground flex items-center gap-2">
                <Car className="w-4 h-4 text-accent" /> Select Cab Type
              </Label>
              <div className="grid grid-cols-2 gap-3">
                {cabTypes.map((cab) => (
                  ...
                  >
                    ...
                    <div className="font-semibold text-card-foreground text-sm">{cab.name}</div>
                    <div className="text-xs text-muted-foreground">{cab.price}</div>
                  </button>
                ))}
              </div>
              ...
              <div className="p-4 rounded-xl bg-accent/10 border border-accent/20">
                ...
                <div className="text-2xl font-bold ucab-text-gradient">{estimatedFare}</div>
              </div>
            </div>
          </div>
